...
// 메모장 우상단에 떠 있는 탭 내 찾기 바. Cmd+F 로 열고 Esc 로 닫는다.
// Enter / ↓ = 다음, Shift+Enter / ↑ = 이전. 동작은 부모(MeetingForm)가 처리.
export function FindBar({
  ...
  return (
    <div
      className="absolute right-4 top-16 z-30 flex items-center gap-1 rounded-lg px-1.5 py-1 shadow-md"
      style={{
